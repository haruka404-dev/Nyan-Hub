...
function MakeWindow(Configs)
  ...
  function MinimizeButton(Configs)
    ...
    local Button = Create("ImageButton", ScreenGui, {
      ...
      Image = http://www.roblox.com/asset/?id=94984196507309,
      Active = true,
      Draggable = true
  ...
  function MakeTab(Configs)
    ...
    if TabTitle then
      Create("TextLabel",Container,{BackgroundTransparency=1,Text="#"..string.gsub(TabName," ","-"),TextSize=25,Font=Configs_HUB.Tex  
  local Frame1 = Create("Frame", Menu_Notifi, {
    Size = UDim2.new(2, 0, 0, 0),
    BackgroundTransparency = 1,
    AutomaticSize = "Y",
